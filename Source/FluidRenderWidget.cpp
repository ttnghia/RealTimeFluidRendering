...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
const std::shared_ptr<ParticleSystemData>& FluidRenderWidget::getParticleDataObj() const
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setBox(const Vec3f& boxMin, const Vec3f& boxMax)
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initOpenGL()
{
    initRDataSkyBox();
    initRDataLight();
    initRDataFloor();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::resizeOpenGLWindow(int w, int h)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderOpenGL()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::updateMeshes()
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::updateNumMeshes(int numMeshes)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::updateLights()
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataLight()
{
    m_Lights = std::make_shared<PointLights>();
    m_Lights->setNumLights(1);

    m_Lights->setLightPosition(Vec4f(10, 10, -10, 1.0), 0);
    //    m_Lights->setLightPosition(Vec4f(0, 100, 100, 1.0), 1);
    //    m_Lights->setLightDiffuse(Vec4f(1.0), 0);
    //    m_Lights->setLightDiffuse(Vec4f(0.7), 1);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderLight()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setSkyBoxTexture(int texIndex)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataSkyBox()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderSkyBox()
{
    Q_ASSERT(m_SkyBoxRender != nullptr);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setFloorTexture(int texIndex)
{
...
void FluidRenderWidget::setFloorSize(int size)
{
    ...
    m_PlaneRender->transform(Vec3f(0.0), Vec3f(static_cast<float>(size)));
    m_PlaneRender->scaleTexCoord(static_cast<float>(size), static_cast<float>(size));
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataFloor()
{
    ...
    m_PlaneRender->transform(Vec3f(0, -0.01, 0), Vec3f(3));
    m_PlaneRender->scaleTexCoord(3, 3);
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderFloor()
{
    Q_ASSERT(m_PlaneRender != nullptr);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataBox()
{
    Q_ASSERT(m_UBufferCamData != nullptr);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderBox()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setParticleColorMode(int colorMode)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setFluidRenderMode(int renderMode)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::updateParticleData()
{
    Q_ASSERT(m_RDataParticle.initialized);
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataParticle()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initFluidVAOs()
{
    Q_ASSERT(m_RDataParticle.initialized);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::uploadParticleColorData()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderParticles()
{
    Q_ASSERT(m_RDataParticle.initialized);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initParticleDataObj()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::computeParticleAnisotropyKernel()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataSurfaceGeneration()
{
    ...
    initRDataFilterModifiedGaussian();

    m_FilterFrameBuffer = std::make_unique<OffScreenRender>(width(), height(), 1, GL_R32F);
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataScreenQuadTexRender()
{
    m_ScreenQuadTexRender = std::make_unique<ScreenQuadTextureRender>();
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderScreenQuadTex(const std::shared_ptr<OpenGLTexture>& texture, int texelSize /*= 1*/, float scaleValue /*= 1.0*/)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::runDepthFilter()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::reloadShaders()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::reloadTextures()
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setParticleMaterial(const Material::MaterialData& material)
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setFluidVolumeMaterial(const Material::MaterialData& material)
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setMeshMaterial(const Material::MaterialData& material, int meshID)
{
    makeCurrent();
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setFilterMethod(int method)
{
    Q_ASSERT(method >= 0 && method < static_cast<int>(FilterMethod::NumFilters));

    m_FilterMethod = method;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setNumFilterIteration(int numIteration)
{
    m_NumFilterIteration = numIteration;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setFilterSize(int filterSize)
{
    m_FilterSize = filterSize;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setSurfaceReflectionConstant(int reflectionConstant)
{
    m_ReflectionConstant = static_cast<float>(reflectionConstant) / 100.0f;
}

void FluidRenderWidget::setFluidAttennuationConstant(int attennuationConstant)
{
    m_AttennuationConstant = static_cast<float>(attennuationConstant) / 100.0f;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::enableAnisotropyKernel(bool bAniKernel)
{
    m_RDataParticle.useAnisotropyKernel = bAniKernel ? 1 : 0;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::enableShadow(bool bShadowEnabled)
{
    m_bShadowEnabled = bShadowEnabled;
}

void FluidRenderWidget::visualizeShadowRegion(bool bVisualizeShadow)
{
    m_bVisualizeShadow = bVisualizeShadow;
}

void FluidRenderWidget::setShadowIntensity(int intensity)
{
    m_ShadowIntensity = static_cast<float>(intensity) / 100.0f;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::enableClipPlane(bool bEnable)
{
    if(!isValid()) {
        return;
    }
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::setClipPlane(const Vec4f& clipPlane)
{
    m_ClipPlane = clipPlane;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::enableExportFrame(bool bEnable)
{
    m_bExrportFrameToImage = bEnable;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataDepthPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderDepthPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataThicknessPass()
{
    m_RDataThicknessPass.offScreenRender = std::make_unique<OffScreenRender>(width() * THICKNESS_TEXTURE_SIZE_RATIO, height() * THICKNESS_TEXTURE_SIZE_RATIO, 1, GL_R16F);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderThicknessPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataThicknessFilter()
{
    m_RDataFilterThickness.offScreenRender = std::make_unique<OffScreenRender>(width() * THICKNESS_TEXTURE_SIZE_RATIO, height() * THICKNESS_TEXTURE_SIZE_RATIO, 1, GL_R16F);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::filterThickness()
{
    return;
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataNormalPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderNormalPass(bool t0 /*= false*/)
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataBackgroundPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderBackgroundPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataCompositionPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderCompositionPass()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataFilterBiGaussian()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::filterBiGaussian()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataFilterCurvatureFlow()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::filterCurvatureFlow()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataFilterPlaneFitting()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::filterPlaneFitting()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataFilterModifiedGaussian()
{
    m_RDataFilterModifiedGaussian.shader = ShaderProgram::getScreenQuadShaderFromFile("Shaders/filter-modified-gaussian.fs.glsl", "FilterModifiedGaussian");
    m_ExternalShaders.push_back(m_RDataFilterModifiedGaussian.shader);

    m_RDataFilterModifiedGaussian.ub_CamData        = m_RDataFilterModifiedGaussian.shader->getUniformBlockIndex("CameraData");
    m_RDataFilterModifiedGaussian.u_DepthTex        = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_DepthTex");
    m_RDataFilterModifiedGaussian.u_ParticleRadius  = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_ParticleRadius");
    m_RDataFilterModifiedGaussian.u_FilterSize      = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_FilterSize");
    m_RDataFilterModifiedGaussian.u_MaxFilterSize   = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_MaxFilterSize");
    m_RDataFilterModifiedGaussian.u_ScreenWidth     = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_ScreenWidth");
    m_RDataFilterModifiedGaussian.u_ScreenHeight    = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_ScreenHeight");
    m_RDataFilterModifiedGaussian.u_FilterDirection = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_FilterDirection");
    m_RDataFilterModifiedGaussian.u_DoFilter1D      = m_RDataFilterModifiedGaussian.shader->getUniformLocation("u_DoFilter1D");

    glCall(glGenVertexArrays(1, &m_RDataFilterModifiedGaussian.VAO));

    m_RDataFilterModifiedGaussian.initialized = true;
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::filterModifiedGaussian()
{
    Q_ASSERT(m_RDataFilterModifiedGaussian.initialized);

    Q_ASSERT(m_FilterFrameBuffer != nullptr);
    Q_ASSERT(m_RDataCompositionPass.depthTex != nullptr);

    ////////////////////////////////////////////////////////////////////////////////
    m_RDataFilterModifiedGaussian.shader->bind();
    m_UBufferCamData->bindBufferBase();
    m_RDataFilterModifiedGaussian.shader->bindUniformBlock(m_RDataFilterModifiedGaussian.ub_CamData, m_UBufferCamData->getBindingPoint());

    m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_DepthTex,       0);
    m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_ParticleRadius, m_RDataParticle.pointRadius);
    m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_FilterSize,     m_FilterSize);
    m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_MaxFilterSize,  static_cast<GLint>(MAX_FILTER_SIZE));
    m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_ScreenWidth,    width());
    m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_ScreenHeight,   height());

    glCall(glClearColor(CLEAR_DEPTH_VALUE, CLEAR_DEPTH_VALUE, CLEAR_DEPTH_VALUE, 1.0));
    glCall(glBindVertexArray(m_RDataFilterModifiedGaussian.VAO));
    m_FilterFrameBuffer->beginRender();
    ...
    if(m_FilterMethod == FilterMethod::ModifiedGaussian2D) {
        ...
        for(int i = 0, iend = m_FilterMethod == FilterMethod::ModifiedGaussian1D2D ? m_NumFilterIteration - 1 : m_NumFilterIteration; i < iend; ++i) {
            ...
            m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_FilterDirection, 0);
            m_RDataCompositionPass.depthTex->bind();
            glCall(glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT));
            glCall(glDrawArrays(GL_TRIANGLE_STRIP, 0, 4));
            m_RDataCompositionPass.depthTex->release();
            ...
            m_FilterFrameBuffer->fastSwapColorBuffer(m_RDataCompositionPass.depthTex);
            m_RDataFilterModifiedGaussian.shader->setUniformValue(m_RDataFilterModifiedGaussian.u_FilterDirection, 1);
            m_RDataCompositionPass.depthTex->bind();
            glCall(glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT));
            glCall(glDrawArrays(GL_TRIANGLE_STRIP, 0, 4));
            m_RDataCompositionPass.depthTex->release();
    ...
    m_FilterFrameBuffer->endRender(context()->defaultFramebufferObject());
    glCall(glBindVertexArray(0));
    m_RDataFilterModifiedGaussian.shader->release();
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataMeshes()
{
    Q_ASSERT(m_UBufferCamData != nullptr && m_Lights != nullptr);
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderMeshes()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataFluidShadow()
{
    for(int i = 0; i < MAX_NUM_LIGHTS; ++i) {
    ...
    m_PlaneRender->setFluidShadowMaps(m_RDataFluidShadowMap.fluidShadowMaps);
    m_PlaneRender->setFluidShadowThickness(m_RDataFluidShadowThickness.fluidShadowThickness);
}

//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::generateFluidShadowMaps()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::generateFluidShadowThicknessMaps()
{
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::initRDataSolidShadow()
{
    ////////////////////////////////////////////////////////////////////////////////
    // light depth buffer
    if(!m_RDataSolidLightDepthMap.initialized) {
        ...
        m_PlaneRender->setSolidShadowMaps(m_RDataSolidLightDepthMap.solidShadowMaps);
    }
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::generateSolidLightDepthMaps()
{
    //    if(m_NumMeshes == 0)
    //        return;
...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
void FluidRenderWidget::renderSolidCameraDepthMap()
{
    if(m_NumMeshes == 0) {
        return;
    }
